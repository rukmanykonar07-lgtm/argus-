...
function addClient({ name, status, notes, tenant_id, target_cpa, target_roas, monthly_budget, webhook_url }) {
...
function updateClient(id, { status, notes, target_cpa, target_roas, monthly_budget, webhook_url }) {
...
function getClientSummary(clientId, { days = 30, since, until, platform } = {}) {
  ...
  return {
    ...
    brandInsight, goalInsight, pacing, recommendedActions, searchVisibilityAvg,
    deltas: {
